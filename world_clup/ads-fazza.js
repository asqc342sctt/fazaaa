(function() {
    ...
    // وظيفة إنشاء الإعلان البانر النيتف
    function createNativeBanner() {
        const wrapper = document.createElement('div');
        wrapper.className = 'fazza-native-ad';
        wrapper.style.cssText = 'display:flex;justify-content:center;margin:20px auto;width:100%;clear:both;';
        
        const container = document.createElement('div');
        container.id = 'container-507ab538554c988bb7f0c8a30d4dc31b';
        
        const script = document.createElement('script');
        script.async = true;
        script.setAttribute('data-cfasync', 'false');
        script.src = 'https://exceedbronzetooth.com/507ab538554c988bb7f0c8a30d4dc31b/invoke.js';
    ...
    function autoInjectAds() {
        ...
        // د. الإعلان البانر النيتف (بعد الإعلان العلوي)
        const firstAd = document.querySelector('.fazza-ad-unit');
        if (firstAd) {
            firstAd.after(createNativeBanner());
        }
    }
